...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //查看车票
        btn_mytickets=view.findViewById(R.id.btn_mytickets);
...
//
//                //将homefr替换布局
//                transaction.replace(R.id.tb,myticketsFragment);
//                transaction.commit();//提交事务
        ...
        //退票
        btn_deltickets=view.findViewById(R.id.btn_deltickets);
        btn_deltickets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
